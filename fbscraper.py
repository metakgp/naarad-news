        ...
        for post_dict in data:
            ...
            if "story" in post_dict:  # Events and shared post have story key
                if "event" in post_dict['story']:
                    ...
                    post_dict['pic'] = get_event_picture(
                        post_dict['id'], dir='docs')
                elif "shared" in post_dict['story']:

                    post_dict['message'] = '<b>' + post_dict['story'] + \
...
if __name__ == "__main__":
    ...
    stamp = "            <font size=2 color=\"white\"><div align=\"right\"><b>Last updated: " + \
        localtime + " IST</b></div></font>\n"
